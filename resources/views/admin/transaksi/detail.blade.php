                   ...
                   <div class="col-md-7">
                    <table>
                        ...
                        <tr>
                            <td></td>
                            <td></td>
                            <td  class="p-2"><a href="{{ route('admin.transaksi.konfirmasi',['id' => $order->id]) }}" onclick="return confirm('Yakin ingin mengonfirmasi pesanan ini?')" class="btn btn-primary mt-1">Konfirmasi Telah Bayar</a><button type="button" class="badge badge-success ml-3 mt-3" data-bs-toggle="modal" data-bs-target="#exampleModal">Lihat Gambar</button><br>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <img src="{{ asset('storage/'.$order->bukti_pembayaran) }}" alt="" srcset="" class="img-fluid" width="">
      </div>
